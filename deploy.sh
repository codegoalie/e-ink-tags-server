...
VERSION="$1"
IMAGE_NAME="ghcr.io/codegoalie/e-ink-tags-server"
IMAGE_TAG="${IMAGE_NAME}:${VERSION}"
APP_NAME="hungry_ruben"
...
REMOTE_HOST="casaos"
COMPOSE_FILE="/var/lib/casaos/apps/$APP_NAME/docker-compose.yml"
...
# shellcheck disable=SC2029
ssh "${REMOTE_HOST}" "cd /var/lib/casaos/apps/${APP_NAME} && sudo -S docker compose down && sudo -S docker compose up -d"
